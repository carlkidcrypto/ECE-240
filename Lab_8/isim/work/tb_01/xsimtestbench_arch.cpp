...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("simprims_ver","ffsrce", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("simprims_ver","X_BUF", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("simprims_ver","X_BUFGMUX", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("simprims_ver","X_INV", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("simprims_ver","X_IPAD", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("simprims_ver","X_LUT4", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("simprims_ver","X_OBUF", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("simprims_ver","X_ONE", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("simprims_ver","X_OPAD", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("simprims_ver","X_ZERO", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("simprims_ver","X_ZERO", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("simprims_ver","X_OPAD", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("simprims_ver","X_ONE", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("simprims_ver","X_OBUF", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("simprims_ver","X_LUT4", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("simprims_ver","X_IPAD", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("simprims_ver","X_INV", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("simprims_ver","X_BUFGMUX", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("simprims_ver","X_BUF", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("work","Lab_8_crazy_counter_mealy_machine", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF23);
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_tb_01_testbench_arch(const char*);
        topvh = createWork_tb_01_testbench_arch("TB_01");
        addChild(topvh);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMglbl(const char*);
