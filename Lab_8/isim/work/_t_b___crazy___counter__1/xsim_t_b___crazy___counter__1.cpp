...
va_list vap)
{
    extern HSim__s6 * createworkM_t_b___crazy___counter__1(const char*);
    HSim__s6 *blk = createworkM_t_b___crazy___counter__1(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","TB_Crazy_Counter_1", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("simprims_ver","ffsrce", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("simprims_ver","X_BUF", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("simprims_ver","X_BUFGMUX", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("simprims_ver","X_INV", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("simprims_ver","X_IPAD", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("simprims_ver","X_LUT4", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("simprims_ver","X_OBUF", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("simprims_ver","X_ONE", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("simprims_ver","X_OPAD", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("simprims_ver","X_ZERO", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("simprims_ver","X_ZERO", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("simprims_ver","X_OPAD", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("simprims_ver","X_ONE", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("simprims_ver","X_OBUF", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("simprims_ver","X_LUT4", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("simprims_ver","X_IPAD", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("simprims_ver","X_INV", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("simprims_ver","X_FF", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("simprims_ver","X_BUFGMUX", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("simprims_ver","X_BUF", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("work","Lab_8_crazy_counter_mealy_machine", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("work","glbl", (HSimInstFactoryPtr)IF24);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_t_b___crazy___counter__1(const char*);
        topvl = (HSim__s5*)createworkM_t_b___crazy___counter__1("TB_Crazy_Counter_1");
